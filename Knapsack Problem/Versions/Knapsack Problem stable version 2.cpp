...
void PrintFile(int position, int number,KnapsackItem arr[])     //Функция вывода в файл
{
...
int main()
{
    ...
    case 1:
        ...
        arr_Items = readfile("List.txt", numberofitems);

        fmain(arr_Items, numberofitems, capacity,position);

        PrintFile(position, numberofitems, arr_Items);
        break;
    ...
    case 2:
        ...
        arr_Items = readfile("Beach.txt", numberofitems);

        //fmain(arr_Items, numberofitems, capacity);
        break;
    ...
    case 3:
        ...
        arr_Items = readfile("Travelling.txt", numberofitems);
